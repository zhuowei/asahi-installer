...
IPSW_VERSIONS = [
    IPSW("11.4",
         ...
         #"http://raider.lan:5000/UniversalMac_11.4_20F71_Restore.ipsw"),
    IPSW("11.5.2",
         "11.5", # guess?
         "iBoot-6723.140.2",
         True,
    ...
    #IPSW("12.0 beta4",
         #"12.0",
         #"iBoot-7429.0.207.141.1",
         #False,
         #"https://updates.cdn-apple.com/2021SummerSeed/fullrestores/071-76100/A4B0FF60-8A75-4743-9D1D-E6DCE733225E/UniversalMac_12.0_21A5294g_Restore.ipsw"),
         #"http://raider.lan:5000/UniversalMac_12.0_21A5294g_Restore.ipsw"),
    IPSW("12.0 beta5",
         "12.0",
         "iBoot-7429.30.8.0.4",
         False,
...
class InstallerMain:
    ...
    def step2_indirect(self):
        ...
        print( "4. Click on the Utilities menu and select Terminal.")
        print( "5. Type the following command and follow the prompts:")
        print()
